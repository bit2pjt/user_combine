...
%>
<!--  
* @Class Name : boardShareWrite.jsp
* @Description : 나눔게시판 작성
...
<body>
 ...
 -->
                     ...
                     <div style="text-align:center; padding:3%;">
                        <input  type="button" id="update-btn" class="btn" value="작성하기" style="width:200px; height: 50px; background-color: #333; color:#fff;margin-right: 20px; border-radius: 6px;"> 
                        
                        <input style="width:200px; height: 50px; background-color: #333; color:#fff; border-radius: 6px;" type="button"                           class="btn" value=" 취 소 " onclick="register_back()">
                     </div>
                  </div>
                  <!-- end of writer-box  -->
               </form>
