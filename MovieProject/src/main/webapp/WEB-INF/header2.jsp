        ...
        <div class="login-content">
            ...
            <form action="Login.do" method="post" name="LoginForm">
                ...
                <div class="row">
                    <div class="remember">
                        <div>
                            <input type="checkbox" id="idSaveCheck" name="remember" value="Remember me"><span>아이디 저장</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="login-content">
            ...
            <div class="row">
                <label for="password">
                    ...
                    신규 비밀번호 입력 </br>
                    <!-- 라벨 추가 -->
                    <input type="password" name="m_password" id="password" placeholder="" required="required"
            ...
            <div class="row">
                <label for="password2">
                    ...
                    비밀번호 확인 </br>
                    <!-- 라벨 추가 -->
                    <input type="password" name="m_password2" id="password2" placeholder="" required="required"
				...
				<div class="row">
					...
					<label for="terms-2"> 약관동의 : </br> 
						<label class="fancy-checkbox custom-bgcolor-coral"> 
							<input class="chk_box" type="checkbox" checked name="useage_agree" value="usage_ok"><span>[필수]이용약관</span>
						</label>  
						<a class="termsLink">약관보기</a> 
						<label class="fancy-checkbox custom-bgcolor-coral">
							<input class="chk_box" type="checkbox" checked name="info_agree" value="info_ok"><span>[필수]개인정보 수집 및 이용</span>
						</label> 
						<a class="termsLink">약관보기</a>
						<input name="m_cert" type="hidden" value="Y"/>
						<label class="fancy-checkbox custom-bgcolor-coral">
							<input class="chk_box" type="checkbox" checked name="m_eagree" value="Y"><span>이메일 수신 동의</span>
						</label>
						<label class="fancy-checkbox custom-bgcolor-coral"> 
							<input class="chk_box"	type="checkbox" checked name="m_sagree" value="Y"><span>SMS 수신 동의</span>
						</label>
					</label>
					<label class="fancy-checkbox custom-bgcolor-coral" id="checkall" >
						<input class="chk_box" type="checkbox" checked id="check_all"><span>전체동의</span>
					</label>
					<hr>
				</div>
