							...
							<tbody>
								...
								<tr>
									...
									<td> 
										<div class="td-content">
											비트인 
											<button class="btn-check-hjs"> 닉네임 변경 </button>		
										</div>
									</td>
								</tr>
								<tr>
										...
										<div class="td-content">
												<label for="terms-2">
													<label class="fancy-checkbox custom-bgcolor-coral">
														<input type="checkbox"><span> 공포/호러 </span>
													</label>
													<label class="fancy-checkbox custom-bgcolor-coral">
														<input type="checkbox" ><span> 멜로/로맨스</span>
													</label>
													<label class="fancy-checkbox custom-bgcolor-coral">
														<input type="checkbox"><span> 액션 </span>
													</label>
													<label class="fancy-checkbox custom-bgcolor-coral">
														<input type="checkbox" ><span> 코미디 </span>
													</label>
													<label class="fancy-checkbox custom-bgcolor-coral">
														<input type="checkbox" ><span> 범죄 </span>
													</label>
													<label class="fancy-checkbox custom-bgcolor-coral">
														<input type="checkbox" ><span> 스릴러 </span>
													</label>	
													<label class="fancy-checkbox custom-bgcolor-coral">
														<input type="checkbox" ><span> 느와르 </span>
													</label>
													<label class="fancy-checkbox custom-bgcolor-coral">
														<input type="checkbox" ><span> 가족 </span>
													</label>
													<label class="fancy-checkbox custom-bgcolor-coral">
														<input type="checkbox" ><span> 애니메이션 </span>
													</label>	
												</label>							
											</div>
										</td>
												...
												<label for="">
													...
													<div class="div-yn">
														<label class="fancy-radio custom-color-coral">
															<input name="smsyn" value="Y" type="radio"><span><i></i>동의함</span>
														</label>
														<label class="fancy-radio custom-color-coral">
															<input  name="smsyn"value="N" type="radio"><span><i></i>동의 안함 </span>
														</label> 
													</div><br>
													이메일 수신동의
													<div class="div-yn">
														<label class="fancy-radio custom-color-coral">
															<input name="emailyn" value="Y" type="radio"><span><i></i>동의함</span>
														</label>
														<label class="fancy-radio custom-color-coral">
															<input name="emailyn" value="N" type="radio"><span><i></i>동의 안함</span>
														</label>
													</div>
													</label>
												</div>
