                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div>
                            <form>
                                ...
                                <br>
                                <div class="btn_m">
                                    <input type="button" onClick="location.href='one_update?qna_no=<%=qna_no %>'"  class="btn-check-hjs" value="수정">
                        ...
                        <div>
                            <form>
                                ...
                                <br>
                                <div class="btn_m">
                                    <input type="button" onClick="location.href='one_list'"class="btn-check-hjs" value="> 목록으로 돌아가기">
                                </div>
                            </form>
                        </div>
                        <!--  hm |관리자 답변 폼  끝 -->
