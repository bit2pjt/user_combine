...
<div class="buster-light" style="padding: 75, 600, 75, 600; margin-top:20%; min-width:100px;">
	<!-- 글쓰기 폼의 시작.-->
	<form>
		...
		<div id="writer-box" style="padding: 75, 600, 75, 600">
			...
			<center>
				<div id="top-writer" style="padding: 75, 600, 75, 600">
					...
					<br> <span><strong>&nbsp;&nbsp;제목
						...
						<input name="bf_title"
						style="width: 850px; border-color: #999999; background-color: #FFFFFF; border-style: solid; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px; color: #0000FF;"
						placeholder="제목을 적어주세요"></span> <span>00/50자 남음</span> <br>
					<br> <br> <br> <br>
				</div>
			</center>
			<!-- end of top-writer -->
			...
			<center class="form-style-1" style="background-color: #FFFFFF;">
				<button type="button" class="btn-check"
					OnClick="location.href ='mmlList.do'">등록</button>
				&nbsp;
				<button type="button" class="btn-check"
					OnClick="location.href ='mmlList.do'">취소</button>
			</center>
		</div>
</div>
<!-- end of writer-box -->
