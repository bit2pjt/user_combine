				...
				<div class="col-md-4 col-xs-12">
					<div class="movie-info">
						<div class="movie-title-top1">
							<h2 class="bd-hd">
								영화제목 _ 한국어 <span>2015</span>
							</h2>
							<br>
							<h3>&ensp;영화제목 _ 영어</h3>
							<br>
						</div>
					</div>
					<div class="movie-img">
										...
										<div id="story" class="tab active">
											<div class="row">
												<div class="story-content">
													줄거리<br> 줄거리<br> 줄거리<br> 줄거리<br> 줄거리<br>
												</div>
											</div>
										</div>
										<!-- end | 줄거리 -->
											...
											<div class="row">
													...
													<div class="review-write-star">
														<fieldset class="rating">
															<input type="radio" id="star5" name="rating" value="10" /><label
																class="full" for="star5" title="10"></label> <input
																type="radio" id="star4half" name="rating" value="9" /><label
																class="half" for="star4half" title="9"></label> <input
																type="radio" id="star4" name="rating" value="8" /><label
																class="full" for="star4" title="8"></label> <input
																type="radio" id="star3half" name="rating" value="7" /><label
																class="half" for="star3half" title="7"></label> <input
																type="radio" id="star3" name="rating" value="6" /><label
																class="full" for="star3" title="6"></label> <input
																type="radio" id="star2half" name="rating" value="5" /><label
																class="half" for="star2half" title="5"></label> <input
																type="radio" id="star2" name="rating" value="4" /><label
																class="full" for="star2" title="4"></label> <input
																type="radio" id="star1half" name="rating" value="3" /><label
																class="half" for="star1half" title="3"></label> <input
																type="radio" id="star1" name="rating" value="2" /><label
																class="full" for="star1" title="2"></label> <input
																type="radio" id="starhalf" name="rating" value="1" /><label
																class="half" for="starhalf" title="1"></label>
														</fieldset>
													</div>
												...
												<div class="mv-user-review-item">
													...
													<div class="user-content">
														<p>아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아
														</p>
													</div>
													<div class="user-like">
														<div class="notmyreview">
															<button class="thumbs-up">
																<img class="far fa-thumbs-up" aria-hidden="true"
																	onclick=""> 100
															</button>
															<button class="thumbs-down">
																<img class="far fa-thumbs-down" aria-hidden="true"
																	onclick=""> 10
															</button>
															<button class="warning">
																<img src="resources/images/siren.png" width="40px"
																	height="40px">
															</button>
														</div>
														...
														<div class="myreview" hidden>
															<button>
																<img class="far fa-thumbs-up" aria-hidden="true"
																	onclick="return false;"> 100
															</button>
															<button>
																<img class="far fa-thumbs-down" aria-hidden="true"
																	onclick="return false;"> 10
															</button>
															<a onclick="">수정</a> <a onclick="">삭제</a>
														</div>
													</div>
												</div>
												<!-- end | 한개의 리뷰 -->
