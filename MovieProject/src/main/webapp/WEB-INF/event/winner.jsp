...
<head>
	...
	<!-- CSS files -->
	<!-- c:url jstl 추가부분  -->
	<link rel="stylesheet" href="<c:url value="/resources/css/style.css"/>"> <link rel="stylesheet"
		href="<c:url value="/resources/css/kgh_style.css"/>"> <link rel="stylesheet"
		href="<c:url value="/resources/css/plugins.css"/>"> <!-- 제이쿼리 -->
...
<body>
	...
	<section>
		<div class="jq_tabonoff comm_tab1" style="width: 1200px; margin: 0 auto; margin-top: 40px; ">
			<ul class="jq_tab tab_menu tab-links tabs-mv">
				<ul class="last_event" style="float: right;">
					...
					<li style="width: 120px;height: 40px; background-color: #333;"><a style="color: #fff;"
							href="./lastevent">지난이벤트</a></li>
		...
		<div class="" style="width: 1200px; margin: 0 auto;">
			...
			<p style="color: #333; font-weight: bold; font-size: 14px; margin-bottom: 40px;">&nbsp;&nbsp;&nbsp; 당첨자 이벤트
				<span style="color: red;">2458건</span> 있습니다.</p>
						...
						<div style="width:1500px;">
							...
							<div class="form-style-1"
								...
								<span>
									...
									<input type="text" placeholder="원하시는 내용을 입력하세요"
