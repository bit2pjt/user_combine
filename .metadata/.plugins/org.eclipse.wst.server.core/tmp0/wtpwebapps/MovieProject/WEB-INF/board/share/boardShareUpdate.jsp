...
<%@ page import="com.spring.boardShare.BoardShareVO"%>
<%
...
%>
<!--  
* @Class Name : boardShareUpdate.jsp
* @Description : 나눔게시판 수정
...
* @ 2019.07.24   박현민   header 수정 및  백앤드 작업
* @author BIT 116기 2조
* @since 2019. 07.01
* @version 1.0
* @see
...
<body>
   ...
   <script>
	$(function() {
      ...
      function register_back() {
         ...
         if (confirm(msg) != 0) {
        	 location.href = "/movie/boardShareGet?page=${searchCriteria.page}"
                 + "&perPageNum=${searchCriteria.perPageNum}"
                 + "&searchType=${searchCriteria.searchType}"
                 + "&keyword=${searchCriteria.keyword}"
                 + "&bno=${selectBoardShare.bs_bno}";
         }
   ...
   <!-- 서머노트 웹에서 ... 끝-->
   <input type="hidden" name="bno" value="${selectBoardShare.bs_bno}">
      ...
      <div class="movie-items">
         <div class="container">
            <div class="col-md-12" style="width: 100%;">
               <form name="bsform" action="boardShareUpdateAction" method="post">
                  ...
                  <div class="ws-writer-box">
                     <div>
                        ...
                        <%
                           String bs_category = ((BoardShareVO) request.getAttribute("selectBoardShare")).getBs_category();
                           if (bs_category.equals("티켓나눔")) {
                        %>
                        ...
                        %>
                        <label class="fancy-radio custom-color-coral"> <input
                           name="bs_category" value="티켓나눔" type="radio"><span><i></i>티켓나눔</span>
                        </label>&nbsp;&nbsp;&nbsp;
                        <%
                           }
                           if (bs_category.equals("스낵나눔")) {
                        %>

                        <label class="fancy-radio custom-color-coral"> <input
                           name="bs_category" value="스낵나눔" type="radio" checked><span><i></i>스낵나눔</span>
                        </label>
                        <%
                           } else {
                        %>
                     ...
                     <input type="hidden" name="bs_bno"
                        value="${requestScope.selectBoardShare.bs_bno }" /> <input
                        type="hidden" name="id"
                        value="${requestScope.selectBoardShare.id }" />
                     ...
                     <div class="ws-top-writer">
                        <br> <br> <span><strong>&nbsp;&nbsp;제목
                           ...
                           <input class="post-title" name="bs_title" maxlength="49" placeholder="제목을 적어주세요" value="${requestScope.selectBoardShare.bs_title }"></span> <span id="counter"></span><span>자
                           남음 </span> <br> <br>
                     </div>
                     <!-- end of top-writer -->
                     ...
                     <textarea id="summernote" class="update-content" name="bs_content" style="resize: none;">${requestScope.selectBoardShare.bs_content }</textarea>
                     ...
                     <div style="text-align:center; padding:3%;">
                        <input style="width:200px; height: 50px; background-color: #333; color:#fff; font-weight: bold;" type="button" id="update-btn" class="btn" value="수정하기" style="margin-right: 20px;">
                        &nbsp;&nbsp; 
                        <input style="width:200px; height: 50px; background-color: #333; color:#fff; font-weight: bold;" type="button" class="btn" value=" 취 소 " onclick="register_back()">
                     </div>
