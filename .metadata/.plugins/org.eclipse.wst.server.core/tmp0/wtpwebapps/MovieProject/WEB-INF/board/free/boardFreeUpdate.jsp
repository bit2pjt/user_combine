...
<%@ page import="com.spring.boardFree.BoardFreeVO"%>
<%
...
%>
<!--  
* @Class Name : boardFreeUpdate.jsp
               ...
               <form id="bfform" name="bfform" action="boardFreeUpdateAction" method="post">
                  ...
                  <div class="ws-writer-box">
                     <div>
                        &nbsp;&nbsp;<strong>분류</strong> &nbsp;&nbsp;
                        <%
                           String bf_category = ((BoardFreeVO) request.getAttribute("selectBoardFree")).getBf_category();
                     ...
                     <div class="ws-top-writer">
                        <br> <br> <span><strong>&nbsp;&nbsp;제목
                           ...
                           <input class="post-title" name="bf_title" maxlength="49"
                     ...
                     <div style="text-align:center; padding:3%;">
                        <input style="width:200px; height: 50px;" type="button" id="update-btn" class="board_btn" value="수정하기" style="margin-right: 20px;"> 
